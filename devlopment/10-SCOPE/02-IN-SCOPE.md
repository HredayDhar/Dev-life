...
"In scope" items are the specific features, functions, characteristics, and work that are explicitly included in a project or product. These represent the commitments made to stakeholders about what will be delivered. Clearly defining in-scope items establishes what the team will build, test, and deliver, forming the basis for planning, estimation, and execution.

## 2. Why Does It Matter?

Defining what is in scope matters because it:
- Creates clear commitments to stakeholders about what will be delivered
- Enables accurate estimation and planning
- Provides focus for the development team
- Forms the basis for acceptance criteria and testing
- Supports change control by providing a baseline for comparison
- Helps prioritize work and allocate resources effectively
- Reduces ambiguity and misunderstandings
- Enables measurement of progress against concrete objectives
- Supports contract management and billing
...
- Provides clarity for quality assurance
- Enables effective release planning
- Supports training and documentation planning
- Facilitates vendor and contractor management

## 3. What Problem Does It Solve?

Without clear in-scope definitions, teams experience:
- Unclear expectations leading to stakeholder dissatisfaction
- Scope creep as boundaries become blurred
- Inaccurate estimations causing missed deadlines and budget overruns
- Wasted effort on unnecessary or unclear work
- Poor quality due to undefined acceptance criteria
...
- Damage to team reputation and credibility

## 4. When Should We Use It?

In-scope definition should be used when:
- Starting a new project or product initiative
- Defining features for a release or iteration
- Responding to a request for proposal (RFP)
- Entering into a new contract or agreement
- Planning enhancements to existing systems
- Conducting requirement gathering and analysis
...
- Defining vendor management and souring strategies
